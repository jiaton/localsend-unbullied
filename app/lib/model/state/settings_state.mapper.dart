...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$autoConvertHeic(SettingsState v) => v.autoConvertHeic;
  static const Field<SettingsState, bool> _f$autoConvertHeic = Field(
    'autoConvertHeic',
    _$autoConvertHeic,
  );
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #autoConvertHeic: _f$autoConvertHeic,
  };
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
      ...
      autoConvertHeic: data.dec(_f$autoConvertHeic),
    );
  }
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (autoConvertHeic != null) #autoConvertHeic: autoConvertHeic,
    }),
  );
  @override
  SettingsState $make(CopyWithData data) => SettingsState(
    ...
    autoConvertHeic: data.get(#autoConvertHeic, or: $value.autoConvertHeic),
  );
